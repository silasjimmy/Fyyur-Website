...
def create_venue_submission():
    ...
    seeking_talent = True if venue_details['seeking_talent'] == 'y' else False
...
def create_artist_submission():
    ...
    seeking_venue = True if artist_details['seeking_venue'] == 'y' else False
